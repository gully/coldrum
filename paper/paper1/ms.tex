...
\title{The functional form of spectral lines from symbolic regression of synthetic spectra}
...
The Earth's atmosphere contorts ground-based spectroscopic observations.  The refractive index of the air min\"utely shifts wavelengths. Selective absorption and emission lines censors some regions. The pileup irmass blurs Point Spread Functions (PSFs), scattering light out of the slit.  Many scientific purposes  observations appear immune to these minor perturbations, such as the visible wavelength range. 
